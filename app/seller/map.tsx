  ...
  return (
    <View style={styles.container}>
      ...
      <YStack style={styles.map}>
        <Heading>EMPLACEMENT DE LA MAP</Heading>
      </YStack>
      ...
      <Button
        ...
        onPress={() => router.push("/logged/near")}
      >
        <Text style={styles.buttonText}>Voir tout les dépôts à proximité</Text>
      </Button>
      ...
      <View style={styles.bottomSection}>
        ...
        <Text style={styles.infoText}>
          Nous utilisons votre position pour vous proposer les dépôts les plus
          proches
        </Text>
      </View>
    </View>
