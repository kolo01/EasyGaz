      ...
      <YStack paddingHorizontal={20}>
        <View style={styles.header}>
          <AntDesign
            ...
            color="black"
          />
          <Text fontSize={16} fontWeight={700} color={"#626262"}>
            Détails sur le livreur
          </Text>
        </View>
        ...
        {itemsDispo.map((data, index) => (
          ...
          <View style={styles.Boxed} key={index}>
            ...
            <View>
              ...
              <XStack alignItems="center">
                <Ionicons name="location-outline" size={12} color="black" />
                <Text style={styles.secondaryText}>{data.prix}</Text>
              </XStack>
            </View>
          </View>
          // </TouchableOpacity>
        ...
        <TouchableOpacity onPress={() => router.push("/seller/confirmation")}>
          <Button
          marginTop={100}
            onPress={() => router.push("/seller/confirmation")}
