  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.secondaryTextBold}>Détails de la commande</Text>
      </View>
      ...
      <TouchableOpacity onPress={()=>router.push("/logged/paiement")}>
        <Button backgroundColor={"#1D9A94"} borderRadius={4} padding={15} color={"#fff"}>Continuer  vers le paiement</Button>
      </TouchableOpacity>
    </View>
  );
}
